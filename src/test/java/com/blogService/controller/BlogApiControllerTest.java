...
import com.blogService.dto.AddCommentResponse;
...
class BlogApiControllerTest {
    ...
    public void findAllArticles() throws Exception {
        ...
        resultActions
                ...
                .andExpect(jsonPath("$.data[0].content").value(savedArticle.getContent()))
                .andExpect(jsonPath("$.data[0].title").value(savedArticle.getTitle()));
    }
    ...
    public void findArticle() throws Exception {
        ...
        resultActions.andExpect(status().isOk())
                .andExpect(jsonPath("$.data.content").value(savedArticle.getContent()))
                .andExpect(jsonPath("$.data.title").value(savedArticle.getTitle()));
    }
